...
const PreYok = new EmbedBuilder()
    .setColor("Red")
    .setTitle("Hata")
    .setDescription(`<a:hyr32:1109477567947341925> **Normal bir kullanıcı en fazla 3 proje ekleyebilir, Destek sunucusuna gelerek link limitinizi arttırabilir veya premium alarak sınırsız link ekleme hakkı kazanabilirsiniz.**`)
...
const ProjeEklenmemiş = new EmbedBuilder()
    ...
    .setDescription(`<a:hyr32:1109477567947341925>  **Sisteme hiç proje eklememişsin.**`)
     ...
     /* } else {
        ...
        PreVarmı = "<a:accepted:1109462199216377956>"
        }
